			...
			<div className="bg-white rounded-t-3xl px-7 pt-6 pb-0">
				...
				<div className="flex items-center gap-4 pb-6">
					...
					<div className="flex-1 min-w-0">
						<h2 className="text-[16px] font-bold text-[#2F2D2C]">{user?.name || "Guest"}</h2>
				...
				<div className="flex gap-3 pb-6">
					...
					<div className="flex-1 bg-[#F9F2ED] rounded-2xl py-4 text-center">
						<p className="text-[22px] font-bold text-[#C67C4E]">{orders.filter((o: Order) => o.status === "DELIVERED").length}</p>
